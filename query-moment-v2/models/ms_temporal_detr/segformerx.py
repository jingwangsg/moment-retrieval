...
class SegFormerX(nn.Module):
    ...
    def forward(self, txt_feat, txt_mask, vid_feat):
        B, Lv, _ = vid_feat.shape
        B, Lt, _ = txt_feat.shape
        ...
        return intermediate_states, txt_feat
...
class SegFormerXFPN(nn.Module):
    ...
    def forward(self, vid_feat, txt_feat, txt_mask):
        intermediate_states, txt_feat = self.backbone(vid_feat=vid_feat, txt_feat=txt_feat, txt_mask=txt_mask)
        fpn_states = []
