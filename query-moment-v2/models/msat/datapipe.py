...
class ActivityNetAnnotationProcessor(IterDataPipe):
    ...
    def get_item(self, annotation):
        ...
        item = dict(map_gt=map_gt,
                    gt_times=np.array([gt_s, gt_e]))
...
def build_datapipe_msat(cfg, split):
    ...
    # collect
    from_keys = ["video.hdf5.pad", "text.embs.pad", "text.embs.mask", "text.inds.pad", "gt_times", "map_gt", "gt"]
    to_keys = ["visual_input", "textual_input", "textual_mask", "word_label", "gt_times", "gt_maps", "gt"]
