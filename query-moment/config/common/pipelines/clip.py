...
load_hf_embeddings_txt = L(HuggingfaceEmbedding)(
...
sample_video = L(SequenceSampler)(axis=0, max_len=256, from_key="video_id_hdf5")
...
pipeline_cfg.update(
    dict(
        pre_processors=[load_hf_embeddings_txt, pad_txt],
        processors=[
            load_video_hdf5,
            sample_video,
            pad_video,
